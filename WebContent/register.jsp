...
<script type="text/javascript">	
	...
	$.validator.addMethod(
		...
		function(value,element,params){			
			...
			//前端返回的是true，即让其返回false代表该校验器不通过
			return !flag;
		}		
	);
	...
	<div class="container"
		...
		<div class="row">
			...
			<div class="col-md-8"
				...
				<!--  -->
				<form id="myform" class="form-horizontal" action="${pageContext.request.contextPath }/UserAction_register.action" method="post" style="margin-top: 5px;">
