...
<HTML>
	<HEAD>
		...
		<script type="text/javascript">
			$(function(){
				//页面加载完毕后去异步获得分类数据
				$.post(
					"${pageContext.request.contextPath}/AdminAction_findAllCategory.action",
					function(data){
	...
	<body>
		<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/AdminAction_adminAddProduct.action" method="post" enctype="multipart/form-data">
			&nbsp;
			...
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>          <!-- pname, is_hot,market_price,shop_price,cid,pdesc-->
					<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
						市场价格：
					</td>
					<td class="ta_01" bgColor="#ffffff">
