...
<script type="text/javascript">
 function addcart(){
	...
	location.href="${pageContext.request.contextPath}/ProductAction_addProductToCart.action?pid=${product.pid}&buyNum="+buyNum;
 }
		...
		<div class="row">
			...
			<div style="margin: 0 auto; width: 950px;">
				...
				<div class="col-md-6">
					...
					<div>
						<a href="${pageContext.request.contextPath}/ProductAction_productListByCid.action?cid=${cid }&currentPage=${currentPage}">返回列表页面</a>
					</div>
				</div>
			</div>
			<div class="clear"></div>
