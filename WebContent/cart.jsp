	...
	<head>
        ...
        <script type="text/javascript">
			function delProFromCart(pid){
				if(confirm("您是否要删除该项？")){
					location.href="${pageContext.request.contextPath }/ProductAction_delProFromCart.action?pid="+pid;
				} 
			}
			
			function clearCart(){
				if(confirm("您是否要清空购物车？")){
					location.href="${pageContext.request.contextPath }/ProductAction_clearCart.action";
				}
			}
		...
		<div class="container">
			...
			<div style="margin-right:130px;">
				...
				<a href="javascript:void(0);" onclick="clearCart()" id="clear" class="clear">清空购物车</a>
					<a href="${pageContext.request.contextPath}/ProductAction_submitOrder.action">
